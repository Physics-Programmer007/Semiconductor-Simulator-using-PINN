...
import Mesh
from Train import bte_train
from Test import bte_test

epochs = 30000
path = "./"
Nl = 6
L = np.linspace(0, 7, Nl).reshape(-1,1)

Nx = 50  # number of spatial points
Nk = 20  # number of frequency bands
Ns = 16  # number of quadrature points
Np = 8   # number of phonon branches

a = 5.431  # lattice constant
Tr = 300   # reference temperature
dT = 0.5   # delta T
x,mu,w,k = Mesh.oned_mesh(Nx,Ns,Nk,a)
vt0,vt1 = Mesh.oned_vt(k,Tr)
learning_rate = 1e-3
